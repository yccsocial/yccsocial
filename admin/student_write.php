...
exit();
  ...
  $result =  $post -> selectUser($table,"roll_no", $email, $pass);
    $id = $result[0]['id'];
    $name = $result[0]['name'];
      ...
      <div class="d-flex">
        <div class="p-3 flex-grow">
          <div class="bg-white border shadow-sm d-inline-block px-4 text-center floated-navigate">
            <a href="student_index.php?id=<?php echo $token; ?>"><span class="fas fa-tachometer-alt fa-lg d-block my-5" data-toggle="tooltip" data-placement="right" title="Dashboard"></span></a>
            ...
            <a href="student_write.php?id=<?php echo $token; ?>"><span class="fas fa-plus fa-lg d-block my-5 active" data-toggle="tooltip" data-placement="right" title="Add Post"></span></a>
                ...
                <input class="form-control rounded-pill title-of-post" type="text" placeholder="Enter post title">
                  ...
                  <div class="d-flex flex-row mb-4 align-items-center my-4">
                    ...
                    <select class="custom-select rounded-pill post-class " name="class" style="width: 150px;"> 
                      <option value="" selected>1ICT_A</option>
                      <option value="">2CE</option>
                      <option value="">4PRE</option>
                    </select>
                  </div>
