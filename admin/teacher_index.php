			...
			<div class="d-flex">
				<div class="p-3 flex-grow ">
					<div class="bg-white border shadow-sm d-inline-block px-4 text-center floated-navigate" >
						<a href="teacher_index.php?id=<?php echo $token; ?>"><span class="fas fa-tachometer-alt fa-lg d-block my-5 active" data-toggle="tooltip" data-placement="right" title="Dashboard"></span></a>
